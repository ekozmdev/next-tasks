...
const EditTaskForm: React.FC<EditTaskProps> = ({ task }) => {
      ...
      <form action={formAction}>
        ...
        <div className="mt-6">
          ...
          <input
            ...
            required className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300"
          />
        </div>
        <div className="mt-6">
